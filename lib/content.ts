export const contentEs = {
  ...
  galeria: {
    ...
    homeTitle: "Donde el tiempo se convierte en recuerdo.",
    homeDescription: "Cada imagen guarda la emoción de un instante irrepetible.",
  ...
  coleccionesFoto: {
    ...
    intro: "Nuestras colecciones de fotografía están diseñadas para capturar la esencia de su boda. Desde celebraciones íntimas hasta grandes eventos, documentamos cada detalle con una perspectiva artística y cuidadosa.",
    comparisonTitle: "Comparación de colecciones de fotografía",
    tableLabels: {
  ...
  coleccionesVideo: {
    ...
    intro: "Nuestras colecciones de video cinematográfico capturan la emoción y el movimiento de su boda. Cada colección está diseñada para contar su historia de manera auténtica y emotiva.",
    comparisonTitle: "Comparación de colecciones de video",
    tableLabels: {
      features: "Características",
      coverage: "Horas de cobertura",
      videographers: "Videógrafos",
...
export const contentEn = {
  ...
  galeria: {
    ...
    homeTitle: "Where time becomes memory.",
    homeDescription: "Each image holds the emotion of an unrepeatable moment.",
  ...
  coleccionesFoto: {
    ...
    subtitle: "We capture every moment of your wedding with an artistic perspective",
    intro: "Our photography collections are designed to capture the essence of your wedding. From intimate celebrations to large events, we document every detail with an artistic and thoughtful perspective.",
    comparisonTitle: "Photography collections comparison",
    tableLabels: {
      features: "Features",
      coverage: "Coverage hours",
      photographers: "Photographers",
  ...
  coleccionesVideo: {
    ...
    subtitle: "We tell your wedding story in motion",
    intro: "Our cinematic video collections capture the emotion and movement of your wedding. Each collection is designed to tell your story in an authentic and emotional way.",
    comparisonTitle: "Video collections comparison",
    tableLabels: {
      features: "Features",
      coverage: "Coverage hours",
      videographers: "Videographers",
