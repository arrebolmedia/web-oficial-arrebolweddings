...
export default function ColeccionesDeFoto2026() {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <h2 className="font-[var(--font-heading)] text-3xl md:text-4xl text-[var(--foreground)] text-center mb-12 uppercase">
              {coleccionesFoto.addonsTitle}
            </h2>
          </FadeIn>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {coleccionesFoto.addons && coleccionesFoto.addons.map((addon: any, index: number) => (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeIn>
            <p className="text-lg text-[var(--foreground)]/80 leading-relaxed mb-8">
              {coleccionesFoto.customNote}
            </p>
            <p className="text-lg text-[var(--foreground)]/80 leading-relaxed mb-8">
              {coleccionesFoto.whatsappText}
            </p>
            <a
              href={`${WHATSAPP_BASE}${encodeURIComponent(coleccionesFoto.whatsappMessage)}`}
              target="_blank"
            ...
            >
              {coleccionesFoto.whatsappButton}
            </a>
          </FadeIn>
        </div>
      </section>
