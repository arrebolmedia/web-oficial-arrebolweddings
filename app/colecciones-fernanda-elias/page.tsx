...
const whatsappMessage = "¡Hola! Soy Fernanda Elías y deseo más información sobre la Colección de Foto y Video de 10 horas";
  ...
  return (
    <>
      <div>
        ...
        <FadeIn>
          <SectionHeader
            title="Fernanda Elías · Foto y Video"
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn delay={200}>
              <p className="mb-12 text-lg text-[var(--foreground)]/80 leading-relaxed text-center">
                Fotografía y video cinematográfico para contar la historia de tu boda de principio a fin.
                Cada momento capturado desde múltiples perspectivas con autenticidad y emoción.
              </p>
            </FadeIn>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <FadeIn delay={300}>
                <div className="text-center">
                  <p className="font-[var(--font-heading)] text-5xl text-[var(--foreground)] mb-3">30–35</p>
                  <p className="text-xs tracking-[0.25em] uppercase text-[var(--foreground)]/50">
                    Minutos de video
                  </p>
                </div>
