...
const WHATSAPP_MESSAGE = "¡Hola! Estoy interesada en la propuesta para mi boda el 23 de octubre en Hacienda Cocoyoc.";
...
const features = [
  ...
  "Grabación completa de la ceremonia (1.5 horas)",
  "Versión 1 minuto",
];


export default function ColeccionesCocoyoc() {
      ...
      <div>
        ...
        <FadeIn>
          <SectionHeader
            ...
            subtitle="Hacienda Cocoyoc · 23 de octubre"
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <FadeIn delay={100}>
              <p className="text-lg text-[var(--foreground)]/80 leading-relaxed">
                Preparamos esta propuesta especialmente para tu boda en Hacienda Cocoyoc. Una cobertura completa de 10 horas para capturar cada momento de tu día.
              </p>
            </FadeIn>
          </div>
        </section>
              ...
              <div className="bg-white border border-[var(--border-subtle)] p-10 flex flex-col">
                <div className="mb-6">
                  ...
                  <p className="text-sm text-[var(--foreground)]/50 uppercase tracking-wider">
                    Hacienda Cocoyoc · 100 invitados
                  </p>
                </div>
                ...
                <div className="pt-6 border-t border-[var(--border-subtle)] text-center">
                  <p className="text-3xl font-light text-[var(--foreground)]">
                    $35,000 <span className="text-sm text-[var(--foreground)]/50 uppercase tracking-wider">MXN</span>
                  </p>
                </div>
              </div>
            </FadeIn>
