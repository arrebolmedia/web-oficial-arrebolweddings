...
export default function ColeccionesSebastianRamirez() {
  const { content, language } = useLanguage();
  const { colecciones } = content;

  const pageTitle = language === "es" 
    ? "COLECCIONES: SEBASTIÁN RAMÍREZ & ARREBOL WEDDINGS"
    : "COLLECTIONS: SEBASTIÁN RAMÍREZ & ARREBOL WEDDINGS";
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeIn>
            ...
            <a
              href={`https://wa.me/5217775001071?text=${encodeURIComponent(language === "es" ? "Hola! Vengo de parte de Sebastián Ramírez y me gustaría conocer más sobre las colecciones de fotografía y video para bodas." : "Hi! I'm coming from Sebastián Ramírez and I would like to know more about the wedding photography and video collections.")}`}
              target="_blank"
