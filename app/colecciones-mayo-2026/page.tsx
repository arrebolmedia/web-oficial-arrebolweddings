...
export default function ColeccionesMayo2026() {
  const { content, language } = useLanguage();
  const { colecciones } = content;

  const pageTitle = "COLECCIONES MAYO 2026 | ARREBOL WEDDINGS";

  const mayoContent = {
    es: {
      subtitle: "30% de descuento en fotografía y video — sólo durante mayo",
      intro: "Durante mayo, celebramos la temporada de bodas con 30% de descuento en todas nuestras colecciones de fotografía y video. Una oportunidad para asegurar los recuerdos de tu gran día con un precio especial.",
      ...
      whatsappText: "¿Lista para reservar tu fecha con 30% de descuento? Escríbenos por WhatsApp y conversemos sobre tu boda.",
      whatsappButton: "Contactar por WhatsApp",
      whatsappMessage: "¡Hola! 🌸 Me interesa la promoción de Colecciones Mayo 2026 con 30% de descuento en fotografía y video para bodas. Me gustaría recibir más información.",
    },
    en: {
      subtitle: "30% off on photography and video — May only",
      intro: "During May, we celebrate wedding season with 30% off on all our wedding photography and video collections. A unique opportunity to secure the memories of your special day at a special price.",
      ...
      whatsappMessage: "Hello! 🌸 I'm interested in the May 2026 Collections promotion with 30% off on wedding photography and video. I would like more information.",
    },
  };

  const texts = language === "es" ? mayoContent.es : mayoContent.en;
