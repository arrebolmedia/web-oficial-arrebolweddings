...
const whatsappMessage =
  "¡Hola! Somos Ginna y Carlos (boda 3 de octubre 2026, Atrio). Nos interesa la propuesta de foto y video de 4 horas con dron por $20,000 MXN. ¿Está disponible nuestra fecha?";

export default function ColeccionesGinnaCarlos() {
  return (
    <>
      <div>
        {/* Header */}
        <FadeIn>
          <SectionHeader
            title="GINNA & CARLOS"
            subtitle="3 de octubre 2026 • Atrio"
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <FadeIn>
              <p className="text-lg text-[var(--foreground)]/80 leading-relaxed mb-4">
                Si tienen algo específico en mente —un horario distinto, una locación especial
                o necesitan más horas de cobertura— podemos armar una propuesta a la medida.
              </p>
              <p className="text-lg text-[var(--foreground)]/80 leading-relaxed mb-8">
                ¿Listos para apartar el 3 de octubre? Escríbannos por WhatsApp y conversemos
